...
-- STORE PROCEDURE
-- LA THU TUC LUU, NHUNG NHUNG HAM VIET TRONG RDBMS, CHAY BEN TRONG CSDL, STORE CHAY RAT NHANH
-- KHI DUNG NO BEN JAVA THI NO RAT LA GON, BOI VI CAU LENH PHUC TAP MINH VIET HET TRONG STORE NAY
-- DAU TIEN TA TAO STORE RA
-- CAU LENH INSERT
GO

CREATE PROC storeProceInsertCategory(@Name nvarchar(50), @NameVN nvarchar(50))
AS
BEGIN
...
-- CAU LENH TIM KIEM GIUA MIN VA MAX
CREATE PROC storeProceSearchProduct(@min FLOAT, @max FLOAT)
AS
BEGIN
	SELECT * FROM Products WHERE UnitPrice BETWEEN @min AND @max
END
GO
-- CAU LENH KIEM TRA HANG TON KHO INVENTORY, KHONG CO THAM SO THI KHONG CAN DAU ()

CREATE PROC storeProceInventory
AS
BEGIN
	SELECT c.Id 'MA LOAI',
	c.NameVN 'TEN LOAI',
...
SELECT * FROM Categories
-- CHAY STORE
EXEC storeProceSearchProduct 9, 10
-- TEST INVENTORY
EXEC storeProceInventory
-- TEST INSERT
EXEC storeProceInsertCategory N'MONITOR', N'MAN HINH'
